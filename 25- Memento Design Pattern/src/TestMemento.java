...
public class TestMemento extends JFrame{
   ...
   // **Create a caretaker that contains the ArrayList with all different Mementos
   // with all the articles in it. It can add and retrieve articles from the ArrayList**
...
//   **saveFiles: no of memento files currently saved
//   currentArticle: which memento file we are currently working with**
   ...
   class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource() == saveBut){
				...
				// Set the value for the current article
				
				originator.set(textInTextArea);
				
				// *Add new memento with a new article (through originator) to the ArrayList*
				...
				if(e.getSource() == undoBut){
					...
					if(currentArticle >= 1){
						...
						// Get the older article saved (through caretaker) and display it in JTextArea
					...
					if((saveFiles - 1) > currentArticle){ // neden saveFiles-1(?) 
